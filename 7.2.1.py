...
#target everywhere to show growth rate faster with inducer
...
def main():
    ...
    plt.suptitle('Change in concentration of species over time with inducer present ddddddddddddddddddddddddddddd')
    plt.tight_layout()
